...
if ( ! function_exists( 'better_ads_get_ad_data_default' ) ) {
	 ...
	 * @return array
	 */
	function better_ads_get_ad_data_default() {
...
if ( ! function_exists( 'better_ads_get_ad_data_override' ) ) {
	 ...
	 */
	function better_ads_get_ad_data_override( $panel_ad_prefix = '', $multiple = FALSE, $type = 'ad-location' ) {

		$data_ids = better_ads_get_ad_data_default();
...
function better_ads_get_ad_data( $panel_ad_prefix = '', $multiple = FALSE ) {
	...
	$final_ads = array();
	$data      = better_ads_get_ad_data_override( $panel_ad_prefix, $multiple );
