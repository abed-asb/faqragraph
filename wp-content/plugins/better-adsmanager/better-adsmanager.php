		...
		switch ( $banner_data['type'] ) {
			...
			case 'code':
				...
				//
				{
					...
					if ( ! empty( $ad_data['width'] ) && ! empty( $ad_data['height'] ) ) {
						$c_width  = $ad_data['width'];
						$c_height = $ad_data['height'];
					...
					if ( $c_width && $c_height ) {
						...
						foreach ( $_check as $_size ) {

							if ( empty( $banner_data[ $_size ] ) ) {
								$banner_data[ $_size ] = array(
									$c_width,
									$c_height,
								);
							}
