...
class Better_Framework {
	...
	public $sections = array(
		...
		'booster'                => TRUE,    // For initializing BS Booster
		'content-injector'       => FALSE,   // For initializing post content injection
		'json-ld'                => FALSE,   // For initializing json-ld schema generator
		'version-compatibility'  => FALSE,   // For initializing version compatibility manager
		'template-compatibility' => FALSE,   // For initializing files compatibility manager
	);
	...
	public static function register_styles() {
		...
		if ( is_admin() ) {
			bf_enqueue_script( 'selector-modal' );
		}
	}
