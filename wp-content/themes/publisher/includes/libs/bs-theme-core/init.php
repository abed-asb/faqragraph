...
class Publisher_Theme_Core {
	...
	/**
	 * Init 'editor-shortcodes' section
	 */
	function editor_shortcodes() {

		$is_ajax = defined( 'DOING_AJAX' ) && DOING_AJAX;
		if ( ! $is_ajax || is_user_logged_in() ) {
			include self::get_dir_path() . 'editor-shortcodes/init.php';
		}

		include self::get_dir_path() . 'editor-shortcodes/shortcodes.php';
