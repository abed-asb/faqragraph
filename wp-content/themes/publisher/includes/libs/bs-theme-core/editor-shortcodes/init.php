...
class Publisher_Theme_Editor_Shortcodes {
	...
	public function load_editor_css() {
		...
		if ( isset( $_GET['publisher-theme-editor-shortcodes'] ) ) {

			@header( 'Content-Type: text/css; charset=UTF-8' );

			// IF post ID was bigger than 0 == valid post
			if ( intval( $_GET['publisher-theme-editor-shortcodes'] ) > 0 ) {
	...
	public function prepare_editor_style_uri( $stylesheets ) {
		...
		$stylesheets[] = site_url( '?publisher-theme-editor-shortcodes=' . bf_get_admin_current_post_id() );
