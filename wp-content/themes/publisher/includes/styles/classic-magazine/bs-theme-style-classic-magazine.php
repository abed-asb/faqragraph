...
/**
 * Publisher
 *      -> Classic Magazine Demo
 */
class Publisher_Theme_Style_Classic_Magazine extends Publisher_Theme_Style {
	...
	public function __construct() {
		...
		$this->style_id = 'classic-magazine';
	...
	function register_assets() {
		...
		bf_enqueue_style(
			...
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_uri( 'classic-magazine/style' ), '.css' ),
			array( 'publisher' ),
			bf_append_suffix( Publisher_Theme_Styles_Manager::get_path( 'classic-magazine/style' ), '.css' ),
	...
	public function register_tinymce_assets() {
		bf_enqueue_tinymce_style( 'registered', 'publisher-theme-classic-magazine' );
	}
	...
	function panel_std( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/classic-magazine/panel-std.php';
	...
	function panel_css( $fields ) {
		...
		include PUBLISHER_THEME_PATH . 'includes/styles/classic-magazine/panel-css.php';
