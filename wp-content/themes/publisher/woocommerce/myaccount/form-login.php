...
<div class="u-columns col2-set" id="customer_login">
	...
	<div class="u-column1 col-1">
		...
		<form method="post" class="login">
			...
			<h2 class="section-heading <?php echo publisher_get_block_heading_class(); ?>"><span class="h-text"><?php esc_html_e( 'Login', 'woocommerce' ); ?></span>
			</h2>
			...
			<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
				...
				<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="username"
				       id="username" value="<?php if ( ! empty( $_POST['username'] ) ) {
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="register">
			...
			<h2 class="section-heading <?php echo publisher_get_block_heading_class(); ?>"><span class="h-text"><?php esc_html_e( 'Register', 'woocommerce' ); ?></span>
			</h2>
			...
			<p class="woocommerce-FormRow woocommerce-FormRow--wide form-row form-row-wide">
				...
				<input type="email" class="woocommerce-Input woocommerce-Input--text input-text" name="email"
				       id="reg_email" value="<?php if ( ! empty( $_POST['email'] ) ) {
			...
			<div style="<?php echo( ( is_rtl() ) ? 'right' : 'left' ); ?>: -999em; position: absolute;"><label
					for="trap"><?php esc_html_e( 'Anti-spam', 'woocommerce' ); ?></label><input type="text"
			                                                                                    name="email_2"
			                                                                                    id="trap"
			                                                                                    tabindex="-1"/></div>
