								...
								<div class="action-links clearfix">
									...
									<script type="text/javascript">
										if (document.referrer) {
											document.write('<div class="search-action-container"><a href="javascript: history.go(-1);"><i class="fa fa-angle-double-right"></i> <?php publisher_translation_echo( '404_go_previous_page' ); ?></a></div>');
										}
									</script>
